...
// export const getProducts = async (req: Request, res: Response) => {
//   const { sortBy, order, category, page, limit } = getQueryParams(req);
//   const { sort, sortOrder } = getSorting(sortBy, order);
//   const { page: currentPage, limit: pageSize } = getPagination(page, limit);
//   const categoryId = category ?? 0;  // Provide default value for category if undefined
//   console.log(sortBy, order, category, page, limit);
